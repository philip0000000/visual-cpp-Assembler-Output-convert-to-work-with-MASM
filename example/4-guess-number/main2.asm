...
; 102  :         return &_OptionsStorage;
	...
	lea	rax, OFFSET ?_OptionsStorage@?1??__local_stdio_scanf_options@@9@4_KA ; `__local_stdio_scanf_options'::`2'::_OptionsStorage ;FLAT:
...
; 15   : 		scanf_s("%d", &userinput);
	...
	lea	rcx, OFFSET ??_C@_02DPKJAMEF@?$CFd@ ;FLAT:
	call	scanf_s
...
; 23   : 			printf("to high!");
	...
	lea	rcx, OFFSET ??_C@_08GOOACKMJ@to?5high?$CB@ ;FLAT:
	jmp	SHORT $LN19@main
$LN7@main:
...
; 25   : 			printf("to low!");
	...
	lea	rcx, OFFSET ??_C@_07CKDDJAOJ@to?5low?$CB@ ;FLAT:
$LN19@main:
...
; 26   : 		printf("%d\n", userinput);
	...
	mov	edx, DWORD PTR userinput$[rsp]
$LN9@main:
	lea	rcx, OFFSET ??_C@_03PMGGPEJJ@?$CFd?6@ ;FLAT:
	call	printf
	jmp	SHORT $LL4@main
$LN18@main:
...
; 20   : 			printf("Found it!");
	...
	lea	rcx, OFFSET ??_C@_09PINPAJPJ@Found?5it?$CB@ ;FLAT:
	call	printf
	mov	edx, DWORD PTR userinput$[rsp]
	lea	rcx, OFFSET ??_C@_03PMGGPEJJ@?$CFd?6@ ;FLAT:
	call	printf
